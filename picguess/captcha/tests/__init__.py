# -*- coding: utf-8 -*-
from picguess.captcha.conf import settings
from picguess.captcha.models import CaptchaStore
...
class CaptchaCase(TestCase):
    urls = 'picguess.captcha.tests.urls'

    def setUp(self):
        self.default_challenge = settings.get_challenge()()
        self.math_challenge = settings._callable_from_string('picguess.captcha.helpers.math_challenge')()
        self.chars_challenge = settings._callable_from_string('picguess.captcha.helpers.random_char_challenge')()
        self.unicode_challenge = settings._callable_from_string('picguess.captcha.helpers.unicode_challenge')()
